...
| **2/3/2026** | Safe RL: Lyapunov & reachability | **Lyapunov-based Safe RL** (eg [[arXiv](https://arxiv.org/abs/1801.08757)]) | **Reachability-Based Safety for Learning Systems** (eg [[arXiv](https://arxiv.org/abs/2108.06266)]) | Control barrier functions; MPC + learning; robust RL formulations | Project proposal |
